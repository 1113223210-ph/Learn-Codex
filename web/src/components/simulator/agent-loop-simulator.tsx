...
// 1:1 直接映射，每章对应自己的场景文件
const scenarioModules: Record<string, () => Promise<{ default: Scenario }>> = {
  ch01: () => import("@/data/scenarios/ch01.json") as Promise<{ default: Scenario }>,
  ch02: () => import("@/data/scenarios/ch02.json") as Promise<{ default: Scenario }>,
  ch03: () => import("@/data/scenarios/ch03.json") as Promise<{ default: Scenario }>,
  ch04: () => import("@/data/scenarios/ch04.json") as Promise<{ default: Scenario }>,
  ch05: () => import("@/data/scenarios/ch05.json") as Promise<{ default: Scenario }>,
  ch06: () => import("@/data/scenarios/ch06.json") as Promise<{ default: Scenario }>,
  ch07: () => import("@/data/scenarios/ch07.json") as Promise<{ default: Scenario }>,
  ch08: () => import("@/data/scenarios/ch08.json") as Promise<{ default: Scenario }>,
  ch09: () => import("@/data/scenarios/ch09.json") as Promise<{ default: Scenario }>,
  ch10: () => import("@/data/scenarios/ch10.json") as Promise<{ default: Scenario }>,
  ch11: () => import("@/data/scenarios/ch11.json") as Promise<{ default: Scenario }>,
